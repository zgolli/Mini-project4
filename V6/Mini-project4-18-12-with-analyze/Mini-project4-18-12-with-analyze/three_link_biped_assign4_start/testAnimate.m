...
addpath('./kinematics', './control', './dynamics', './set_parameters/', ...
    './solve_eqns/', './visualize', './analysis', './perturbation')


global optData h_ i_ j_ k_ m_ n_ p_ q_ plotsOn input_with_step_number u_vs_time1 u_vs_time2 u_vs_timet; %optimization data structure, along with global indices so it can be populated from other functions
u_vs_time1=[];
u_vs_time2=[];
u_vs_timet=[];
...
dq0 = [0;0;0];
num_steps = 25;
input_with_step_number=zeros(num_steps,2);
